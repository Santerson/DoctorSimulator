...
{
    public static void DrawBox(Vector2 min, Vector2 max, Color color = default)
    {
    ...
    public static void DrawCircle(Vector2 center, float radius, Color color = default, int numberOfPoints = 16)
    {
